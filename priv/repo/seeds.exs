...
#
#     Todku.Repo.insert!(%Todku.SomeSchema{})
#
...
poems = [
  ...
  %Poem{
    date: ~D[2022-04-29],
    text: "when the winds begin<br>some trees will try to be strong<br>the old trees will flex"
  },
  %Poem{
    date: ~D[2022-04-28],
